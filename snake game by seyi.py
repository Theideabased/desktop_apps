...
class Snake(Canvas):
    ...
    def load_img(self):
        try:
            self.snake_body = ImageTk.PhotoImage(Image.open('C:/Users/SEYI/Pictures/snake.png'))
            self.food = ImageTk.PhotoImage(Image.open('C:/Users/SEYI/Pictures/snake.png'))
